...
int main()
{
    ...
    {
        myUtil::Shader vShader("../shader/vertexShader.txt", myUtil::VERTEX_SHADER);
        myUtil::Shader fShader("../shader/fragmentShader.txt", myUtil::FRAGMENT_SHADER);
...
//    glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        float blueValue = sin((sin((float)timeValue) / 2 + 0.5) + timeValue) / 2 + 0.5;
        float alphaValue = 1;

        // draw our first triangle
        program.use();
        program.set4Float("color", redValue, greenValue, blueValue, alphaValue);
